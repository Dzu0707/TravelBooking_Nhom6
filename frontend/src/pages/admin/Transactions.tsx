...
const AdminTransactions = () => {
  ...
  const renderStatus = (status: string) => {
    ...
    return (
      <span
        className={`inline-flex items-center rounded-full border px-2.5 py-1 text-[9px] font-bold uppercase tracking-[0.16em] ${c.bg} ${c.color} ${c.border}`}
      >
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-xl border border-slate-800 bg-slate-900/95 p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_20px_60px_rgba(2,6,23,0.45)]">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <button
              ...
              className="group flex items-center gap-2 rounded-xl border border-cyan-500/20 bg-cyan-500/10 px-5 py-3 text-[11px] font-bold uppercase tracking-[0.18em] text-cyan-300 transition-all hover:bg-cyan-500/15"
            >
        ...
        <Grid numItemsMd={2} numItemsLg={3} className="gap-4">
          ...
          <Card className="rounded-xl border border-slate-800 bg-slate-900 p-5 shadow-none">
            ...
            <Metric className="mt-2 text-2xl font-black text-cyan-300">
              {transactions.length}
            </Metric>
          </Card>
        </Grid>
                ...
                filteredData.map((t) => (
                  ...
                  >
                    <TableCell className="p-5">
                      <Flex justifyContent="start" className="gap-3">
                        ...
                        <div>
                          ...
                          <Text className="mt-1 text-[10px] font-mono text-slate-600">
                            BOOKING: {t.bookingId}
                          </Text>
                        </div>
                      </Flex>
                    ...
                    <TableCell className="p-5">
                      ...
                      <Text className="mt-1 text-[10px] font-mono text-slate-500">
                        {t.orderCode} • {t.paymentMethod}
                      </Text>
                      <Text className="mt-1 text-[10px] text-slate-500">{t.tourName}</Text>
                      <Text className="mt-1 flex items-center gap-1 text-[10px] text-slate-500">
                        <Phone size={10} />
                        {t.contactPhone || 'N/A'}
                      </Text>
                      <Text className="mt-1 flex items-center gap-1 text-[10px] text-slate-500">
                    ...
                    <TableCell className="p-5">
                      <Text className="text-[14px] font-bold text-emerald-400">
